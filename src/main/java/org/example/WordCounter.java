...
public class WordCounter {
    ...
    public static Map<String, Integer> calculatedWord() {
        ...
        String defaultText = "When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü, "
    ...
    public static Map<String, Integer> calculatedWord(String text) {
        ...
        String cleanedText = text.replaceAll("[^a-zA-Z0-9çğıöşüİ]", " ").toLowerCase();
