...
public class Main {
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee(1, "Dilara", "Beyhan");
        Employee employee2 = new Employee(2, "Umit", "Beyhan");
        Employee employee3 = new Employee(3, "Melike", "Atestepe");
        Employee employee6 = new Employee(3, "Iklime", "Atestepe");
